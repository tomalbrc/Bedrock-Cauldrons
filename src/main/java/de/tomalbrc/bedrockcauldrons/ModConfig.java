...
public class ModConfig {
    static Path CONFIG_FILE_PATH = FabricLoader.getInstance().getConfigDir().resolve("bedrock-cauldrons.json");
    static ModConfig instance;
    static Gson JSON = new GsonBuilder().setPrettyPrinting().create();

    @SerializedName("allow-tipped-arrows")
    public boolean tippedArrows = true;

    @SerializedName("allow-potion-bottles")
